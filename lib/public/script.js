...
function deep_link (options) {
  ...
  console.log(url);
  console.log(ios_store_link);
  console.log(android_package_name);
  console.log(play_store_url);
  ...
  console.log('is_mobile' + is_mobile.ios());
  console.log('is_mobile' + urls.ios_deep_link);
  console.log('is_mobile' + is_mobile.ios());
